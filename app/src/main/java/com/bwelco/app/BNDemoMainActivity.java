...
//            showToastMsg("TTSPlayStateListener : TTS play start");
	...
	private void routeplanToNavi(CoordinateType coType) {
		...
		switch (coType) {
			case GCJ02: {
				sNode = new BNRoutePlanNode(118.894324,31.940233, "南京市江宁区龙眠大道180号", null, coType);
			...
			case BD09_MC: {
				sNode = new BNRoutePlanNode(12947471, 4846474, "南京市江宁区龙眠大道180号", null, coType);
	...
	public class DemoRoutePlanListener implements RoutePlanListener {
		...
		public void onJumpToNavigator() {
			...
			Toast.makeText(BNDemoMainActivity.this, "onJumpToNavigator", Toast.LENGTH_SHORT).show();
